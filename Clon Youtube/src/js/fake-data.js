...
function imprimirHTML() {
    ...
    const html = `
        <div id="videos" class="h-64 w-72 m-2 mt-10">
            <div id="sup" class="overflow-hidden rounded h-auto">
                <img class="h-auto rounded-lg" src="./images/Youtube.jpg">
            </div>
            <div id="inf" class="h-auto flex mt-3">
                <div id="img" class="w-2/12 ml-2">
                    <img class="h-8 w-8" src="./images/perfil.png" alt="" id="profile">
                </div>
                <div id="info" class="ml-3 flex flex-col 8/12">
                    <strong id="titulo" class="font-bold text-base"></strong>
                    <span id="canal" class="text-alto-600 text-sm mt-1"></span>
                    <div class="flex text-xs">
                        <span id="visualize"></span>
                        <div class="h-1 w-1 rounded-full bg-alto-800"></div>
                        <span id="time"></span>
                    </div>
                </div>
                <div id="points" class="w-1/12">
                    <i class="fa-solid fa-ellipsis-vertical opacity-0"></i>
                </div>
            </div>
        </div>
    `;
